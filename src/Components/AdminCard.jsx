...
const AdminCard = ({ time, date, name, city, pincode, phoneNumber, state }) => {
  ...
  return ended ? null : (
    <div className="relative service-card w-3/4 md:w-[320px] lg:w-[350px] shadow-xl cursor-pointer snap-start shrink-0 py-8 px-6 bg-white flex flex-col items-center gap-3 transition-all duration-300 group hover:bg-[#202127] text-black hover:text-white">
      <p className="font-bold text-2xl ">{name}</p>
      <p className="font-bold text-xl ">{phoneNumber}</p>
      <p className="font-semibold text-xl text-center text-wrap">
        {city}, {state}, {pincode}
      </p>
